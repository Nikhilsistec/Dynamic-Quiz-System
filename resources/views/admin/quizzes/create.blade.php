...
@section('page-description', 'Fill in the details below to create a new quiz.')
        ...
        <form action="{{ route('admin.quizzes.store') }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}"
                       ...
                       placeholder="e.g. General Knowledge Quiz" required>
                @error('title')
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-3 text-sm bg-gray-50/50 dark:bg-gray-700/50 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-400 transition-all"
                          placeholder="Optional introduction shown before the quiz starts">{{ old('description') }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="number" name="time_limit_minutes" id="time_limit_minutes"
                       value="{{ old('time_limit_minutes') }}" min="1" max="480"
            ...
            <div class="flex items-center gap-3">
                ...
                <label for="is_published" class="text-sm font-medium text-gray-700 dark:text-gray-200">Publish immediately</label>
            </div>
