...
<p class="text-xs text-indigo-600 dark:text-indigo-400 font-medium mb-2">Select all that apply.</p>
<div class="space-y-2">
    @foreach($question->options as $option)
        <label class="flex items-start gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 cursor-pointer transition-colors">
            <input type="checkbox"
                   ...
                   value="{{ $option->id }}"
                   class="mt-0.5 h-4 w-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded shrink-0">
